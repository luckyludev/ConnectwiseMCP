...
| `list_schedule_entries`                                                                                                            | **Migrated narrowly**    | Fixed schedule route, 50-item cap, allowlisted projection, and mandatory server-side scoping to the member ID in the mapped profile; callers cannot select a member.                                                   |
